...
public class Clothes {
	...
	/**
	 * @param tshirtNum (value 1)
	 */
	public WebElement getTshirtProduct(int tshirtNum) {
		return Utils.waitForElementPresence(driver, By.xpath("//*[@id=\"center_column\"]/ul/li[" + tshirtNum + "]"), 30);

	}


	public List<WebElement> getTshirtCount() {
		return driver.findElements(By.xpath("//*[@id=\"center_column\"]/ul/li"));
	}
}